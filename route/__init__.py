...
api.add_resource(create_audiobook, f'{ENDPOINT}/create_audiobook', methods=['POST'])
docs.register(create_audiobook)
api.add_resource(AudiobooksListAPI, f'{ENDPOINT}/list_audiobook', methods=['GET'])
docs.register(AudiobooksListAPI)
api.add_resource(VoteAPI, f'{ENDPOINT}/vote', methods=['POST'])
docs.register(VoteAPI)